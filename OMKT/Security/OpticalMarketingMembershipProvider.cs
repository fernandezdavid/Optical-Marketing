...
namespace OMKT.Models.Security
{
    public class OpticalMarketingMembershipProvider : MembershipProvider
    {
        #region Properties
        ...
        public override MembershipUser CreateUser(string username, string password, string email, string passwordQuestion, string passwordAnswer, bool isApproved, object providerUserKey, out MembershipCreateStatus status)
        {
            ...
            using (OMKTDB Context = new OMKTDB())
            {
                ...
                var newUser = new User
                {
                    ...
                    {
                        Name = "Optical Marketing SA",
                        ContactPerson = "David Fernández",
                        Address = "Obispo Trejo 1173 7 A",
                        CP = "5000",
                        CompanyNumber = "5600012",
                        City = "Córdoba",
                        Phone1 = "5600022",
                        Email = "info@opticalmarketing.com.ar",
                    }
        ...
        public override bool ValidateUser(string username, string password)
        {
            ...
            using (OMKTDB Context = new OMKTDB())
            {
                ...
                //var customer = Context.UsersByCustomers.FirstOrDefault(user => user.UserId == User.UserId);
                //if (customer == null)
                //    return false;
