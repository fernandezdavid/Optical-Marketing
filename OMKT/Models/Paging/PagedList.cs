...
namespace Paging
{
    public class PagedList<T> : List<T>, IPagedList<T>
    {
        ...
        {
            if (index < 0)
                throw new ArgumentOutOfRangeException("index", "El valor no puede ser menor a 0.");
            if (pageSize < 1)
                throw new ArgumentOutOfRangeException("pageSize", "El valor no puede ser menor a 1.");
